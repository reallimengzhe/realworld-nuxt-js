...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/_username/index.vue?vue&type=template&id=49865c13&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"profile-page"},[_c('AuthorBanner',{attrs:{"author":_vm.username}}),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"container\">","</div>",[_vm._ssrNode("<div class=\"row\">","</div>",[_vm._ssrNode("<div class=\"col-xs-12 col-md-10 offset-md-1\">","</div>",[_vm._ssrNode("<div class=\"articles-toggle\">","</div>",[_vm._ssrNode("<ul class=\"nav nav-pills outline-active\">","</ul>",[_vm._ssrNode("<li class=\"nav-item\"><a href class=\"nav-link active\">My Articles</a></li> "),_vm._ssrNode("<li class=\"nav-item\">","</li>",[_c('NuxtLink',{staticClass:"nav-link",attrs:{"to":'/@' + _vm.profile.username + '/favorites'}},[_vm._v("\n                Favorited Articles\n              ")])],1)],2)]),_vm._ssrNode(" <div class=\"article-preview\""+(_vm._ssrStyle(null,null, { display: (_vm.feedLoading) ? '' : 'none' }))+">\n          Loading articles...\n        </div> <div class=\"article-preview\""+(_vm._ssrStyle(null,null, { display: (!_vm.feedLoading && _vm.articles.length < 1) ? '' : 'none' }))+">\n          No articles are here... yet.\n        </div> "),_vm._l((_vm.articles),function(article){return _c('ArticlePreview',{key:article.slug,attrs:{"data":article}})}),_vm._ssrNode(" <nav><ul class=\"pagination\">"+(_vm._ssrList((Math.ceil(_vm.articlesCount / _vm.pageLimit)),function(pageNumber){return ("<li"+(_vm._ssrClass(null,['page-item', { active: pageNumber === _vm.pageIndex }]))+"><a class=\"page-link\">"+_vm._ssrEscape(_vm._s(pageNumber))+"</a></li>")}))+"</ul></nav>")],2)])])],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/_username/index.vue?vue&type=template&id=49865c13&
...
/* harmony default export */ var _usernamevue_type_script_lang_js_ = ({
  ...
  async asyncData({
    ...
    // 用户名
    let username = route.path.slice(2); // 用户信息
